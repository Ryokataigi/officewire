...
- "category": "design" = office space/architecture, "work" = employment, labor market, hybrid/remote work policy, or how people work more broadly — not limited to office settings, "estate" = office building/commercial office space (leasing, vacancy, rent, office REITs, office construction/conversion) — NOT hotels, warehouses/industrial, retail, residential, or parking facilities, "culture" = HR/company culture/org policy, "ai" = how AI or digital tools/automation are changing jobs, the labor market, workflows, or office real estate demand — not limited to office settings. If a story is about work policy or real estate but AI/automation is the central driver, prefer "ai" over "work" or "estate".
...
- If the article is not actually about the workplace/work broadly defined — office space, office buildings, office-adjacent commercial real estate, workplace culture/policy, hybrid work, employment/labor market trends, or how AI/automation is changing jobs — respond with {"skip": true} instead. For example, skip stories about hotels, industrial/warehouse property, retail, residential real estate, or parking facilities that have no connection to work or employment. General AI/tech/business news IS in scope when it's substantively about jobs, employment, or how people work.
- "bullets": exactly 3, purely factual, no interpretation — what happened, who, numbers.
- "insight": ONE sentence of genuine analysis, written as OfficeWire's own editorial voice — NOT a restatement of the bullets. It must do one of: (a) explain why this matters for the office/workplace industry, (b) connect it to a broader trend readers would recognize, or (c) offer a critical or forward-looking perspective (e.g. a risk, a contradiction, an open question). Write it with a confident, slightly provocative editorial voice — like a sharp editor's aside, not a textbook summary. If you cannot produce a genuinely analytical sentence that adds something beyond the facts, write the most defensible interpretation you can rather than restating a bullet.
- Titles: write like a sharp, opinionated editor teasing a story worth stopping to read — punchy and specific, built around the most surprising or consequential true detail. Never invent facts or exaggerate numbers. Avoid dry press-release phrasing like "Company X Announces Y" — lead with what's actually at stake or surprising instead.
